...
<head>
  ...
  <style>
    ...
    .wrap{max-width:900px;margin:auto;padding:20px;border-radius:8px;border:1px solid #ccc;}
    .ok{padding:12px;border:1px solid #999;border-radius:6px}
    .err{padding:12px;border:1px solid #999;border-radius:6px}
    pre{padding:12px;border-radius:6px;overflow:auto;border:1px solid #ccc;}
    table{width:100%;border-collapse:collapse;margin-top:10px}
    th,td{padding:8px;border-bottom:1px solid #ccc;text-align:left}
    a.btn{display:inline-block;padding:8px 12px;border:1px solid #000;border-radius:6px;text-decoration:none}
  </style>
</head>
<body>
  <div class="wrap">
    ...
    <?php if ($result['success']): ?>
      ...
      ?>
        <h4>Preview:</h4>
        <img src="<?=htmlspecialchars($result['file']['relative_path'])?>" alt="preview" style="max-width:100%;border:1px solid #ccc;padding:6px;border-radius:6px">
      <?php endif; ?>

      <p style="margin-top:14px;">
        <a class="btn" href="<?=htmlspecialchars($result['file']['relative_path'])?>" target="_blank">Buka / Download</a>
        <a class="btn" href="fileupload.php" style="margin-left:8px">Unggah Lagi</a>
      </p>
